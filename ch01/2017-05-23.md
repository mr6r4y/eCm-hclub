...
Used to move data memory-to-memroy. The source memory address is
...
; You can see it represented by tools with added implicit operands of destination
; and source for convenience of the disassembly reading.
;
;   rep movsd dword es:[edi], dword ptr [esi]
;   movsd dword es:[edi], dword ptr [esi]
;
rep movsd   ; (6 + 1) * 4 bytes = 0x1c
movsd
```

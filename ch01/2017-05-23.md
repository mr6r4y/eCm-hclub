...
Understands large number of architectures and formats | Steep learning curve
It is a command line tool | It is a command line tool in its base form
You can run in several environments - Linux, OSX, Windows |
It is light-weight |
Script automation |
...
wall of shame and be unabled to get license ever
...
I will use analogy with Eclipse - I know Java programmers that left without their magickal IDE
